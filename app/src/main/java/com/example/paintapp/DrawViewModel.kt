...
data class Drawing(
    val id: Long, // Unique identifier for the drawing (maybe use id auto generated by room database to also be the file name (path) that backend uses
    val bitmap: Bitmap, // Bitmap for storing the drawing
    val fileName: String //user chosen name (does not reflect actual name in database)
)
